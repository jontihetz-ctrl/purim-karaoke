...
def generate():
    ...
    filtered_thankyou = 0
    for row in rows:
        queue_id, image_id, image_file, transcription, language, script, commenter, source, post_url, post_date, post_author = row
        # Only include if image file exists locally
